...
(function ($, window) {
  ...
  $.fn.bootpag = function (options) {
      ...
      settings.leftPageText = '顯示第 ' + start + ' 到第 ' + end + ' 項紀錄，總共 ' + settings.dataCount + ' 項紀錄;每頁顯示';
      ...
      function perPageNumbersView() {
          ...
          var selectStr = '<div class="bootpag_drop col-md-4">' + settings.leftPageText +
          ...
          return selectStr + optionsStr + '</select>' + settings.rightPageText + '</div>';
      }
