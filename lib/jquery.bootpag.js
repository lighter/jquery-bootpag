...
(function ($, window) {
  ...
  $.fn.bootpag = function (options) {
      ...
      function goToPageView(page) {
          var inputStr = '<div style="display: flex; margin: 22px 22px 0 22px;"><div style="margin: 6px 0;">' + settings.goToPage1 + '</div>' +
            '<div class="col-md-5" style="padding:0 0 0 0;"><input type="number" class="bootpage_go_to_page form-control" value="' + page + '"></div><div style="margin: 6px 0;">' + settings.goToPage2 + '</div>';
      ...
      return this.each(function () {
          ...
          me.append(p.join(''));
          me.append(goToPageView(parseInt(settings.page, 10)));
          ...
          me.find('input.bootpage_go_to_page').keyup(function () {
            $(this).val($(this).val()
              .replace(/[^\d]/g, '')
              .replace(/^\.*/, ''));
          });
          ...
          me.find('input.bootpage_go_to_page').change(function() {
              ...
              if (page <= parseInt(me.data('pagecount'), 10) && page > 0) {
                renderPage($bootpag, page, ppn);
                $owner.trigger('page', [page, ppn]);
              }
          });
