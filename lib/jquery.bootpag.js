...
(function ($, window) {
  ...
  $.fn.bootpag = function (options) {
      ...
      function perPageNumbersView() {
          ...
          var content = '顯示第 ' + start + ' 到第 ' + end + ' 項記錄，總共 ' + settings.dataCount + ' 項記錄;每頁顯示';
          var selectStr = '<div class="bootpag_drop col-md-4">' + content +
          ...
          return selectStr + optionsStr + '</select>  項記錄 </div>';
      }
