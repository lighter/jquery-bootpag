  ...
  $.fn.bootpag = function (options) {
    ...
    var $owner = this,
      settings = $.extend({
          ...
          page: 1,
          maxVisible: null,
          perPageNumbers: [10, 20, 50, 100, 500],
    ...
    function perPageNumbersView() {
      ...
      var selectStr = '<div class="col-md-1">' + settings.perPageText +
    ...
    return this.each(function () {
      ...
      $owner.find('select.bootpage_per_numbers').change(function paginationChange() {
        var page = parseInt(me.find('li.active').attr('data-lp'), 10);
